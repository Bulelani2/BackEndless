/**
 * This code is a view model class that fetches data from a UnitData class and assigns it to a list of reflections.
 * It also contains functions to start and stop loading, as well as to start and stop errors.
 */
