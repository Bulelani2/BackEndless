/**
 * This code is part of a ReflectionService class which is used to get, save and delete reflections.
 * It also contains a setter and getter for the selectedReflection.
 * It also contains a method to empty the list of reflections.
 * It also contains methods to get, save and delete reflections.
 * Finally, it contains
 */
