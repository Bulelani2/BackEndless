/**
 * This code is a user service class that provides functions for user authentication such as login, logout, reset password, and check if user exists.
 * It also contains a function for creating a new user.
 */
